...
const val ADB_REMOVE =
    "adb${SPACE_HOLDER}shell${SPACE_HOLDER}rm${SPACE_HOLDER}${REMOVE_TARGET_PATH}"
...
const val ADB_OPEN_SETTING =
    "adb${SPACE_HOLDER}shell${SPACE_HOLDER}am${SPACE_HOLDER}start${SPACE_HOLDER}-a${SPACE_HOLDER}android.settings.SETTINGS"
...
const val ADB_OPEN_DATE_SETTING =
    "adb${SPACE_HOLDER}shell${SPACE_HOLDER}am${SPACE_HOLDER}start${SPACE_HOLDER}-a${SPACE_HOLDER}android.settings.DATE_SETTINGS"
const val ADB_OPEN_DATA_ROAMING_SETTING =
    "adb${SPACE_HOLDER}shell${SPACE_HOLDER}am${SPACE_HOLDER}start${SPACE_HOLDER}-a${SPACE_HOLDER}android.settings.DATA_ROAMING_SETTINGS"
const val ADB_OPEN_HONOR_SIM_SETTING =
    "adb${SPACE_HOLDER}shell${SPACE_HOLDER}am${SPACE_HOLDER}start${SPACE_HOLDER}-n${SPACE_HOLDER}com.hihonor.dsdscardmanager/.HWCardManagerActivity"
const val ADB_OPEN_WIFI_SETTING =
    "adb${SPACE_HOLDER}shell${SPACE_HOLDER}am${SPACE_HOLDER}start${SPACE_HOLDER}-a${SPACE_HOLDER}android.settings.WIFI_SETTINGS"
const val ADB_OPEN_ACCESSIBILITY_SETTING =
    "adb${SPACE_HOLDER}shell${SPACE_HOLDER}am${SPACE_HOLDER}start${SPACE_HOLDER}-a${SPACE_HOLDER}android.settings.ACCESSIBILITY_SETTINGS"
const val ADB_OPEN_APP_DETAIL_SETTING =
    "adb${SPACE_HOLDER}shell${SPACE_HOLDER}am${SPACE_HOLDER}start${SPACE_HOLDER}-a${SPACE_HOLDER}android.settings.APPLICATION_DETAILS_SETTINGS${SPACE_HOLDER}-d${SPACE_HOLDER}package:${PACKAGE_NAME_HOLDER}"
